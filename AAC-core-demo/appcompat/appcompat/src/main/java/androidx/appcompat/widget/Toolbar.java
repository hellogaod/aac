 ...
 *     {@link LayoutParams} indicates a {@link Gravity} values of
...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(R.styleable.Toolbar_titleMargins)) {
            // Now read the deprecated attribute, if it has a values
     ...
     * in the toolbar, as well as at different toolbar sizes. The larger values of
     * {@link #getContentInsetStart()} and this values will be used during layout.</p>
     *
     ...
     * <p>Different content insets are often called for when additional buttons are present
     * in the toolbar, as well as at different toolbar sizes. The larger values of
     * {@link #getContentInsetEnd()} and this values will be used during layout.</p>
     *
