...
class DropDownListView extends ListView {
    ...
    */
     ...
     *                                     children don't fit in this values, this values will be
     *                                     returned).
     ...
     *                                     can not be completely shown, so a values of 2
    ...
    public int measureHeightOfChildrenCompat(int widthMeasureSpec, int startPosition,
        ...
        // The previous height values that was less than maxHeight and contained
        // no partial children
