...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
     ...
     * <p>
     * This values may be specified as an empty string to prevent any query hint
     ...
     * <ol>
     * <li>Non-null values set with {@link #setQueryHint(CharSequence)}
     ...
     *
     * <p>The default values is true.</p>
     *
     ...
     *
     * @param iconify a true values will collapse the SearchView to an icon, while a false will
     * expand it.
     */
