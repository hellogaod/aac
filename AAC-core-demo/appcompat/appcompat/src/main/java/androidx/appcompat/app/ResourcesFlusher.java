...
class ResourcesFlusher {
    ...
    private static void flushLollipops(@NonNull final Resources resources) {
        ...
        if (sDrawableCacheField != null) {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve values from Resources#mDrawableCache", e);
            }
    ...
    private static void flushNougats(@NonNull final Resources resources) {
        ...
        try {
            ...
            Log.e(TAG, "Could not retrieve values from Resources#mResourcesImpl", e);
        }
        ...
        if (sDrawableCacheField != null) {
            try {
                ...
                Log.e(TAG, "Could not retrieve values from ResourcesImpl#mDrawableCache", e);
            }
        }
    ...
    private static void flushThemedResourcesCache(@NonNull final Object cache) {
        ...
        try {
            ...
            Log.e(TAG, "Could not retrieve values from ThemedResourceCache#mUnthemedEntries", e);
        }
