...
public class TintTypedArray {
     ...
     * @param style A style values used for selecting best match font from the list of family. Note
     * that this values will be ignored if the platform supports font family (API 24 or later).
