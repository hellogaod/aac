...
class AppCompatTextViewAutoSizeHelper {
    ...
    // Default values for the step size in pixels.
    private static final int DEFAULT_AUTO_SIZE_GRANULARITY_IN_PX = 1;
    // Cache of TextView methods used via reflection; the key is the method name and the values is
    ...
    // Cache of TextView fields used via reflection; the key is the field name and the values is
    ...
    /**
     * Specify whether this widget should automatically scale the text to try to perfectly fit
     * within the layout bounds. If at least one values from the <code>presetSizes</code> is valid
