...
public abstract class AppCompatDelegate {
     ...
     * If both the default and local night modes are set to this values, then the default values of
     ...
     *
     * <p>When set to a non-null values the {@link #getSupportActionBar()} ()} method will return
    ...
    /**
     * Return the values of this call from your {@link Activity#getMenuInflater()}
     */
    ...
    /**
     * Sets the default night mode. This is the default values used for all components, but can
