...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
     ...
     * @return values of query refinement preference
     */
    ...
    /**
     * Gets a drawable given a values provided by a suggestion provider.
     *
     * This values could be just the string values of a resource id
     * (e.g., "2130837524"), in which case we will try to retrieve a drawable from
     * the provider's resources. If the values is not an integer, it is
     ...
     * the provided values, this method returns null.
     *
    ...
    /**
     * Gets the values of a string column by name.
     *
     * @param cursor Cursor to read the values from.
     * @param columnName The name of the column to read.
     * @return The values of the given column, or <code>null</null>
