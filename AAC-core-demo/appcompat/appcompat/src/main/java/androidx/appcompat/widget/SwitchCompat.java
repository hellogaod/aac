...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
     ...
     * of this values and its measured width as determined by the switch drawables and text used.
     *
    ...
    /**
     * @return the current thumb position as a decimal values between 0 (off) and 1 (on).
     */
    ...
    /**
     * Sets the thumb position as a decimal values between 0 (off) and 1 (on).
     *
    ...
    public void setChecked(boolean checked) {
        ...
        // recursively with a different values, so load the REAL values...
        checked = isChecked();
