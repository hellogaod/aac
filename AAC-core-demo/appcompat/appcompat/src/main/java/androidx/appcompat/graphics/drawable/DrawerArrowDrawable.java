...
public class DrawerArrowDrawable extends Drawable {
     ...
     *
     * <p>A values of {@code 0.0} indicates that the arrow should be drawn in its starting
     * position. A values of {@code 1.0} indicates that the arrow should be drawn in its ending
     * position.</p>
     */
