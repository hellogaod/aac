...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
         ...
         * {@link Callback#onOpen callback}.
         * <p>
         * All configuration should happen in your {@link Callback#onOpen}
         * callback so it is re-applied every time the database is re-opened. Note that the
         * {@link Callback#onOpen} will be called every time the database is re-opened.
         * <p>
