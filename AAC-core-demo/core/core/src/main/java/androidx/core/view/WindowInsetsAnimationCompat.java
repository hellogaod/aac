...
public final class WindowInsetsAnimationCompat {
     ...
     * </p>
     *
     * @param typeMask       The bitmask of {@link Type}s that are animating.
     ...
     * {@link Callback#onProgress} will only dispatch the insets that
     ...
     * start state of the animation and the end state of the animation. Note
     * that this progress is the global progress of the animation, whereas
     * {@link Callback#onProgress} will only dispatch the
     * insets that may
    ...
    public static final class BoundsCompat {
         ...
         * {@link Callback#onStart} to indicate that a part of the
         ...
         * platform {@link WindowInsetsAnimation.Bounds}.
         */
        @RequiresApi(30)
        @NonNull
    ...
    public abstract static class Callback {
         ...
         * will return {@code false} for {@link Type#ime}.
         *
    ...
    private static class Impl21 extends Impl {
        ...
        static int buildAnimationMask(@NonNull WindowInsetsCompat targetInsets,
            ...
            int animatingMask = 0;
            for (int i = Type.FIRST; i <= Type.LAST;
                    i = i << 1) {
    ...
    private static class Impl30 extends Impl {
        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            ProxyCallback(@NonNull final Callback compat) {
