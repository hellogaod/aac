...
//        mDisposable.add(
//
//                //1.订购者 - (userName -> mUserName.setText(userName)和throwable -> Log.e(TAG, "Unable to get username", throwable)
//                //2.通过subscribe方法订阅了
//                //3.订购事件（上游）Flowable.create().map()
//                //4.订阅使用线程Schedulers.io()
//                //5.订购者使用线程AndroidSchedulers.mainThread()
//                Flowable.create(new FlowableOnSubscribe<User>() {
//                    @Override
//                    public void subscribe(@NonNull FlowableEmitter<User> emitter) throws Exception {
//
//                        emitter.onNext(new User("2", "我是start"));
//                        emitter.onComplete();
//                    }
